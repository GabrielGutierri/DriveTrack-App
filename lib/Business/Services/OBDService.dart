...
class Obdservice {
  ...
  static String velocidade = "0";
  static String rpm = "0";
  static String temperatura = "0";
  static String pressao = "0";
  static String engineLoad = "0";
  static String throttle = "0";
  ...
  Future<void> EnviaComandos(listaComandos, connection) async {
    ...
    for (var comando in listaComandos) {
      ...
      if (comando == "01 0D\r") 
        dadoCarro.velocidade = resposta;
      if (comando == "01 0C\r") 
        dadoCarro.rpm = resposta;
      if (comando == "01 0B\r") 
        dadoCarro.pressaoColetorAdmissao = resposta;
      if (comando == "01 0F\r") 
        dadoCarro.tempArAdmissao = resposta;
      if (comando == "01 04\r") 
        dadoCarro.engineLoad = resposta;
      if (comando == "01 11\r") 
        dadoCarro.throttlePosition = resposta;
    }
    ...
    velocidade = dadoCarro.velocidade;
    rpm = dadoCarro.rpm;
    temperatura = dadoCarro.tempArAdmissao;
    pressao = dadoCarro.pressaoColetorAdmissao;
    engineLoad = dadoCarro.engineLoad;
    throttle = dadoCarro.throttlePosition;
    ELMOcupado = false;
